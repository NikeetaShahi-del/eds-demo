...
/* global WebImporter */
/**
 * Parser for hero-adventure. Base: hero. Source: https://wknd.site/us/en.html
 * Model: hero-adventure (simple block)
 * Fields: image (reference), imageAlt (text, collapsed), text (richtext)
 * Library structure: 1 column, row1=image, row2=text content
 * DOM selector: .teaser.cmp-teaser--hero.cmp-teaser--imagebottom
 */
